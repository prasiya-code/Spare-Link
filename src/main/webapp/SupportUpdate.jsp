...
<body class="bg-gray-50 text-gray-200 font-sans">
   ...
   <%
     ...
     String supportId = request.getParameter("id");
  ...
  <main class="container" style="padding: 3rem 0;">
    <div style="max-width: 800px; margin: 0 auto;">
      <div class="circuit-box" style="border-radius: 0.75rem; overflow: hidden; padding: 1.5rem 2.5rem; margin-bottom: 2rem;">
        ...
        <form action="supportUpdate"method="post"id="support-form" style="display: flex; flex-direction: column; gap: 1.5rem;">
        
        <div>
              <label style="display: block; color: #ccc; margin-bottom: 0.5rem;" for="name">Support ID</label>
